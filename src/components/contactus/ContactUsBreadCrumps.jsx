          ...
          <div className="h-full flex items-center">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="text-lg md:text-xl text-white/80 font-sans tracking-wide pl-1">
                "Discover the story behind our passion for travel."
              </p>
              ...
              <div className="flex items-center gap-2 md:gap-4 pl-1">
                ...
                <span className="text-white text-sm tracking-wider">About</span>
              </div>
            </div>
          </div>
        </div>
...
export default ContactUsBreadCrumps