          ...
          <div className="h-full flex items-center">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <div className="flex items-center gap-2 md:gap-4 pl-1">
                ...
                <a href="/blog" className="text-white/80 hover:text-white text-sm tracking-wider transition-all duration-300 group">
                <span className="text-white text-sm tracking-wider">Blog</span>
                </a>
              </div>
            </div>
          </div>
