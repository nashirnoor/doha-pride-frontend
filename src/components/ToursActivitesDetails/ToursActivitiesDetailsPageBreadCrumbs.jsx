...
const ToursActivitiesDetailsPageBreadCrumbs = () => {
    return (
            ...
            <div className="h-full flex items-center">
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div className="flex items-center gap-2 md:gap-4 pl-1">
                  ...
                  <span className="text-white text-sm tracking-wider">Tours & Activities Detail</span>
                </div>
              </div>
            </div>
          </div>
...
export default ToursActivitiesDetailsPageBreadCrumbs
