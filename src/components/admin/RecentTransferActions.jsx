...
const RecentTransferActions = () => {
  ...
  useEffect(() => {
    const fetchActions = async () => {
      try {
        ...
        const response = await axios.get(`${BASE_URL}api/transfer-audit-dashboard/`,{
          headers:{
  ...
  return (
    <div className="bg-white p-4 m-10 rounded-lg shadow">
      <h2 className="text-xl font-semibold mb-4">Recent Transfer Booking Actions</h2>
...
export default RecentTransferActions;