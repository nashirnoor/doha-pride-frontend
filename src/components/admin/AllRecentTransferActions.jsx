...
const AllRecentTransferActions = () => {
        ...
        const fetchActions = async () => {
            try {
                ...
                const response = await axios.get(
                    `${BASE_URL}api/transfer-audit/?page=${currentPage}&search=${searchTerm}&booking_id=${bookingIdSearch}`,
                    {
                        headers: {
...
export default AllRecentTransferActions;